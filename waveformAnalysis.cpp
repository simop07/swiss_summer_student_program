...
WaveformAnalysis::WaveformAnalysis(std::vector<double> const &s = {},
                                   double ts = {}, double sp = {})
...
void WaveformAnalysis::computeBaseline(int nBaselineSamples = 50) {
  fBaseline = std::accumulate(fSamples.begin(),
                              fSamples.begin() + nBaselineSamples, 0.) /
              nBaselineSamples;
}

double WaveformAnalysis::computeRMS(int nBaselineSamples = 50) {
...
void WaveformAnalysis::findAndIntegratePulse(double tresholdFactor = 30.0,
                                             double tolerance = 20,
                                             int minWidth = 20,
                                             int maxWidth = 20,

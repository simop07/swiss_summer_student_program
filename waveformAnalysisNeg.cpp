...
WaveformAnalysisNeg::WaveformAnalysisNeg(std::vector<double> const &s,
  ...
  WaveformAnalysisNeg::analyseWaveform();  // When a waveform is found, analyse
                                           // it
}

std::vector<double> const &WaveformAnalysisNeg::getSamples() const {
  return fSamples;
}

double WaveformAnalysisNeg::getTimeStamp() const { return fTimeStamp; }

double WaveformAnalysisNeg::getSamplePeriod() const { return fSamplePeriod; }

double WaveformAnalysisNeg::getBaseline() const { return fBaseline; }

std::vector<Pulse> const &WaveformAnalysisNeg::getPulses() const {
  return fPulses;
}

void WaveformAnalysisNeg::analyseWaveform() {
  WaveformAnalysisNeg::baseline();
  WaveformAnalysisNeg::findPulses();
}

void WaveformAnalysisNeg::baseline(int nInitialSamples) {
...
double WaveformAnalysisNeg::RMS(int nInitialSamples) {
